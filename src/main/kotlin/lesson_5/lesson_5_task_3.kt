...
fun main(){
    ...
    val userNumbers = readLine()!!.split(" ")
    val numberOne = userNumbers[0].toInt()
    val numberTwo = userNumbers[1].toInt()
    val result = if (numberOne == FIRST_WIN && numberTwo == SECOND_WIN)
        "Поздравляем! Вы выиграли главный приз!"
    else if (numberOne == FIRST_WIN || numberTwo == SECOND_WIN ||
        numberOne == SECOND_WIN || numberTwo == FIRST_WIN)
